...
//		this.actionLayer.setContentSize(gc_size);
//		
...
//	},
	...
	createBg:function() {
		...
		var bgSprite = cc.Sprite.create(s_bgTable);
		// 精灵居中显示
		offsetX = (gc_size.width - bgSprite.getContentSize().width) / 2;
		offsetY = (gc_size.height - bgSprite.getContentSize().height) / 2;
	...
	createButton: function() {
		...
		this.btnDraw = new Button(s_bgButton1, s_textButton1, 0);
		this.btnPass = new Button(s_bgButton1, s_textButton2, 1);
	...
	createMenu:function() {
		...
		// 创建菜单项内容
		var menuLabel1 = cc.LabelTTF.create(s_textMenuitem3, s_font1, s_fontsize1);
		var menuLabel2 = cc.LabelTTF.create(s_textMenuitem4, s_font1, s_fontsize1);
		var menuLabel3 = cc.LabelTTF.create(s_textMenuitem5, s_font1, s_fontsize1);
		menuLabel1.setColor(gc_color5);
		menuLabel2.setColor(gc_color5);
		menuLabel3.setColor(gc_color5);
		
		// 创建菜单项，显示在左上角
		var menuItem1=cc.MenuItemLabel.create(menuLabel1, this.menu1Selected);
		menuItem2=cc.MenuItemLabel.create(menuLabel2, this.menu2Selected);
		menuItem3=cc.MenuItemLabel.create(menuLabel3, this.menu3Selected);
		...
		offsetX1 = (gc_size.width - menuItem1Width) / 2;
		offsetX2 = (gc_size.width - menuItem2Width) / 2;
		offsetY = (gc_size.height - menuItemHeight) / 2;
...
//		this.addChild(menuLayer);
	...
	createMessage:function() {
		...
		offsetX = gc_size.width / 2;
		offsetY = gc_size.height / 2;
